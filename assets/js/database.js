const DB = {
    ...
    // Dados dos Indicadores (Exatamente do seu TXT)
    indicadores: {
        '2025': {
            ...
            insights: { all: ['Variação: 69.7% a 97.1%.', 'Tendência de recuperação.', 'Brigada: 50.5% treinada.', 'Obstruções reduziram no último tri.'] }
        },
        '2026': {
            conformidade: { labels: ['Jan', 'Fev', 'Mar'], values: [0, 0, 0] },
            obstrucoes: { extintores: [0, 0, 0], hidrantes: [0, 0, 0] },
            evacuacao: { labels: [], tempos: [] },
            insights: { all: ['Ano fiscal iniciado.', 'Aguardando dados de Janeiro.'] }
        }
    },
    // Dados Completos de Treinamento (Todos os 10 do seu TXT)
    treinamentos: [
